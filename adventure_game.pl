...
sub start_game {
    ...
    while (1) {
        ...
        if ($current_room_id eq $game_data{final_destination}) {
            if($game_data{final_message}){
                print "\n\033[92;6m$game_data{final_message}\033[0m\n";
            }
            else{
